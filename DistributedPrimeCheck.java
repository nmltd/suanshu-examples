...
<head>
<meta charset="utf-8" />
<title>/Examples/src/main/java/com/numericalmethod/suanshu/examples/DistributedPrimeCheck.java - Public - Redmine</title>
<meta name="description" content="Redmine" />
<meta name="keywords" content="issue,bug,tracker" />
<meta name="csrf-param" content="authenticity_token" />
<meta name="csrf-token" content="Az9zlGJWTRqF1dpobnLU2kNAoVuKX3RndhH4tf2CEtxCicC2j7vFmC2GUwI+LZ1DVo0zAEW9nI/8k7xTsQAcfw==" />
...
<form id="revision_selector" action="/projects/public/repository/entry/Examples/src/main/java/com/numericalmethod/suanshu/examples/DistributedPrimeCheck.java" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />  <!-- Branches Dropdown -->
...
<h2><a href="/projects/public/repository">svn-public</a>
    ...
    / <a href="/projects/public/repository/changes/Examples/src/main/java/com/numericalmethod/suanshu/examples/DistributedPrimeCheck.java">DistributedPrimeCheck.java</a>
...
<p>
<a href="/projects/public/repository/changes/Examples/src/main/java/com/numericalmethod/suanshu/examples/DistributedPrimeCheck.java">History</a> |
    View |
    <a href="/projects/public/repository/annotate/Examples/src/main/java/com/numericalmethod/suanshu/examples/DistributedPrimeCheck.java">Annotate</a> |
<a href="/projects/public/repository/raw/Examples/src/main/java/com/numericalmethod/suanshu/examples/DistributedPrimeCheck.java">Download</a>
(3.53 KB)
</p>
...
<tbody>
  ...
  <tr id="L23">
    ...
    <td class="line-code">
      <pre><span class="comment">//package com.numericalmethod.suanshu.examples;</span>
</pre>
    </td>
  </tr>
  <tr id="L24">
  ...
  <tr id="L25">
    ...
    <td class="line-code">
      <pre><span class="comment">//import com.numericalmethod.suanshu.analysis.function.Function;</span>
</pre>
    </td>
  </tr>
  <tr id="L26">
    ...
    <td class="line-code">
      <pre><span class="comment">//import com.numericalmethod.suanshu.grid.executor.DefaultGridExecutorFactory;</span>
</pre>
    </td>
  </tr>
  <tr id="L27">
    ...
    <td class="line-code">
      <pre><span class="comment">//import com.numericalmethod.suanshu.grid.executor.GridExecutor;</span>
</pre>
    </td>
  </tr>
  <tr id="L28">
    ...
    <td class="line-code">
      <pre><span class="comment">//import com.numericalmethod.suanshu.number.DoubleUtils;</span>
</pre>
    </td>
  </tr>
  <tr id="L29">
    ...
    <td class="line-code">
      <pre><span class="comment">//import java.util.Iterator;</span>
</pre>
    </td>
  </tr>
  <tr id="L30">
    ...
    <td class="line-code">
      <pre><span class="comment">//import java.util.List;</span>
</pre>
    </td>
  </tr>
  <tr id="L31">
  ...
  <tr id="L33">
    ...
    <td class="line-code">
      <pre><span class="comment">// * Demonstrates how grid API is used to determine whether each of the given</span>
</pre>
    </td>
  </tr>
  <tr id="L34">
    ...
    <td class="line-code">
      <pre><span class="comment">// * integers is prime or not.</span>
</pre>
    </td>
  </tr>
  <tr id="L35">
  ...
  <tr id="L36">
    ...
    <td class="line-code">
      <pre><span class="comment">// * @author Johannes Lehmann</span>
</pre>
    </td>
  </tr>
  <tr id="L37">
  ...
  <tr id="L38">
    ...
    <td class="line-code">
      <pre><span class="comment">//public final class DistributedPrimeCheck {</span>
</pre>
    </td>
  </tr>
  <tr id="L39">
  ...
  <tr id="L41">
    ...
    <td class="line-code">
      <pre><span class="comment">//     * Determines whether a number is prime or not.</span>
</pre>
    </td>
  </tr>
  <tr id="L42">
  ...
  <tr id="L43">
    ...
    <td class="line-code">
      <pre><span class="comment">//    public static class IsPrime implements Function&lt;Integer, Boolean&gt; {</span>
</pre>
    </td>
  </tr>
  <tr id="L44">
  ...
  <tr id="L45">
    ...
    <td class="line-code">
      <pre><span class="comment">//        private static final long serialVersionUID = -6362919406091841135L;</span>
</pre>
    </td>
  </tr>
  <tr id="L46">
  ...
  <tr id="L47">
    ...
    <td class="line-code">
      <pre><span class="comment">//        @Override</span>
</pre>
    </td>
  </tr>
  <tr id="L48">
    ...
    <td class="line-code">
      <pre><span class="comment">//        public Boolean evaluate(Integer in) {</span>
</pre>
    </td>
  </tr>
  <tr id="L49">
    ...
    <td class="line-code">
      <pre><span class="comment">//            int n = Math.abs(in);</span>
</pre>
    </td>
  </tr>
  <tr id="L50">
    ...
    <td class="line-code">
      <pre><span class="comment">//            int sqrtN = (int) Math.floor(Math.sqrt(n));</span>
</pre>
    </td>
  </tr>
  <tr id="L51">
  ...
  <tr id="L52">
    ...
    <td class="line-code">
      <pre><span class="comment">//            for (int i = 2; i &lt;= sqrtN; i++) {</span>
</pre>
    </td>
  </tr>
  <tr id="L53">
    ...
    <td class="line-code">
      <pre><span class="comment">//                if (n % i == 0) {</span>
</pre>
    </td>
  </tr>
  <tr id="L54">
  ...
  <tr id="L61">
    ...
    <td class="line-code">
      <pre><span class="comment">//        public int dimensionOfDomain() {</span>
</pre>
    </td>
  </tr>
  <tr id="L62">
    ...
    <td class="line-code">
      <pre><span class="comment">//            throw new UnsupportedOperationException(&quot;Not supported yet.&quot;); //To change body of generated methods, choose Tools | Templates.</span>
</pre>
    </td>
  </tr>
  <tr id="L63">
  ...
  <tr id="L66">
    ...
    <td class="line-code">
      <pre><span class="comment">//        public int dimensionOfRange() {</span>
</pre>
    </td>
  </tr>
  <tr id="L67">
  ...
  <tr id="L71">
    ...
    <td class="line-code">
      <pre><span class="comment">//    private static final Function&lt;Integer, Boolean&gt; F = new IsPrime();</span>
</pre>
    </td>
  </tr>
  <tr id="L72">
  ...
  <tr id="L73">
    ...
    <td class="line-code">
      <pre><span class="comment">//    private DistributedPrimeCheck() {</span>
</pre>
    </td>
  </tr>
  <tr id="L74">
  ...
  <tr id="L77">
    ...
    <td class="line-code">
      <pre><span class="comment">//     * Runs the program.</span>
</pre>
    </td>
  </tr>
  <tr id="L78">
  ...
  <tr id="L81">
    ...
    <td class="line-code">
      <pre><span class="comment">//    public static void main(String[] args) {</span>
</pre>
    </td>
  </tr>
  <tr id="L82">
    ...
    <td class="line-code">
      <pre><span class="comment">//        GridExecutor executor</span>
</pre>
    </td>
  </tr>
  <tr id="L83">
    ...
    <td class="line-code">
      <pre><span class="comment">//                = DefaultGridExecutorFactory.getInstance().newExecutor();</span>
</pre>
    </td>
  </tr>
  <tr id="L84">
  ...
  <tr id="L85">
    ...
    <td class="line-code">
      <pre><span class="comment">//        List&lt;Integer&gt; numbers = DoubleUtils.intArray2List(DoubleUtils.seq(10, 20));</span>
</pre>
    </td>
  </tr>
  <tr id="L86">
  ...
  <tr id="L87">
    ...
    <td class="line-code">
      <pre><span class="comment">//        List&lt;Boolean&gt; areNumbersPrime = executor.map(numbers, F);</span>
</pre>
    </td>
  </tr>
  <tr id="L88">
  ...
  <tr id="L89">
    ...
    <td class="line-code">
      <pre><span class="comment">//        System.out.println(&quot;results: &quot; + areNumbersPrime.toString());</span>
</pre>
    </td>
  </tr>
  <tr id="L90">
    ...
    <td class="line-code">
      <pre><span class="comment">//        printResults(numbers, areNumbersPrime);</span>
</pre>
    </td>
  </tr>
  <tr id="L91">
  ...
  <tr id="L93">
    ...
    <td class="line-code">
      <pre><span class="comment">//    private static void printResults(</span>
</pre>
    </td>
  </tr>
  <tr id="L94">
    ...
    <td class="line-code">
      <pre><span class="comment">//            List&lt;Integer&gt; numbers,</span>
</pre>
    </td>
  </tr>
  <tr id="L95">
    ...
    <td class="line-code">
      <pre><span class="comment">//            List&lt;Boolean&gt; areNumbersPrime) {</span>
</pre>
    </td>
  </tr>
  <tr id="L96">
  ...
  <tr id="L97">
    ...
    <td class="line-code">
      <pre><span class="comment">//        Iterator&lt;Boolean&gt; isPrimeItr = areNumbersPrime.iterator();</span>
</pre>
    </td>
  </tr>
  <tr id="L98">
  ...
  <tr id="L99">
    ...
    <td class="line-code">
      <pre><span class="comment">//        for (Integer number : numbers) {</span>
</pre>
    </td>
  </tr>
  <tr id="L100">
    ...
    <td class="line-code">
      <pre><span class="comment">//            System.out.printf(&quot;%d %s prime%n&quot;,</span>
</pre>
    </td>
  </tr>
  <tr id="L101">
    ...
    <td class="line-code">
      <pre><span class="comment">//                              number,</span>
</pre>
    </td>
  </tr>
  <tr id="L102">
    ...
    <td class="line-code">
      <pre><span class="comment">//                              isPrimeItr.next() ? &quot;is&quot; : &quot;is not&quot;);</span>
</pre>
    </td>
  </tr>
  <tr id="L103">
